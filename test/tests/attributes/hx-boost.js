describe('hx-boost attribute', async function() {
    ...
    it('handles basic anchor properly', async function () {
        ...
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><a id="a1" href="/test">Foo</a></div>')
    ...
    it('handles basic form post properly', async function () {
        ...
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><form id="f1" action="/test" method="post"><button id="b1">Submit</button></form></div>')
    ...
    it('handles basic form post with button formaction properly', async function () {
        mockResponse('POST', '/test', 'Boosted')
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><form id="f1" action="/bad" method="post"><button id="b1" formaction="/test">Submit</button></form></div>')
        await clickAndWait('#b1')
        playground().innerHTML.should.equal('Boosted')
    })
    ...
    it('handles basic form post with button formmethod properly', async function() {
        mockResponse('POST', '/test', 'Boosted')
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><form id="f1" action="/test" method="get"><button id="b1" formmethod="post">Submit</button></form></div>')
        await clickAndWait('#b1')
        playground().innerHTML.should.equal('Boosted')
    })
    ...
    it('handles basic form post with button formmethod & formaction properly', async function() {
        mockResponse('POST', '/test', 'Boosted')
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><form id="f1" action="/bad" method="get"><button id="b1" formmethod="post" formaction="/test">Submit</button></form></div>')
        await clickAndWait('#b1')
        playground().innerHTML.should.equal('Boosted')
    })
    ...
    it('handles basic form post properly w/ explicit action', async function() {
        mockResponse('POST', '/test', 'Boosted')
        initHTML('<div hx-target:inherited="this"><form id="f1" action="/test" method="post"  hx-boost="true"></form></div>')
    ...
    it('handles basic form get properly', async function() {
        debug(this)
        mockResponse('GET', '/test', 'Boosted')
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><form id="f1" action="/test" method="get"><button id="b1">Submit</button></form></div>')
        await clickAndWait('#b1')
        playground().innerHTML.should.equal('Boosted')
    })
    ...
    it('handles basic form with no explicit method property', async function() {
        mockResponse('GET', '/test', 'Boosted')
        initHTML('<div hx-target:inherited="this" hx-boost:inherited="true"><form id="f1" action="/test"><button id="b1">Submit</button></form></div>')
