describe("Core htmx Parameter Handling", function () {
  ...
  it("Input includes form", function () {
    var form = make(
      '<form><input id="i1" name="foo" value="bar"/><input id="i2" name="do" value="rey"/></form>'
    );
    var input = byId("i1");
    var vals = htmx._("getInputValues")(input).values;
    vals["foo"].should.equal("bar");
  ...
  it("non-input includes form", function () {
    var form = make(
      '<form><div id="d1"/><input id="i2" name="do" value="rey"/></form>'
    );
    var div = byId("d1");
  ...
  it("correctly URL escapes values", function () {
    ...
    htmx
      ._("urlEncode")({ foo: "bar", do: "rey" })
      .should.equal("foo=bar&do=rey");
    htmx
  ...
  it("Input within disabled fieldsets are excluded", function () {
    var input = make(
