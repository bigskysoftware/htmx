...
| `extensions`          | `""`                    | Comma-separated extension names to approve             |
...
Extensions are loaded via script tag and approved via meta config:
...
The `extensions` config is a comma-separated list of approved extension names. Only approved extensions are active.
