...
Download `htmx.min.js` <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-alpha1/dist/htmx.min.js">from jsDelivr</a> 
...
htmx offers a bunch different ways to swap the HTML returned into the DOM.  By default, the content replaces the
