...
```html
<button class="btn primary" hx-trigger="click, keyup[altKey&&shiftKey&&code=='KeyD'] from:body"
...
<script>
    ...
    init("/init", function(request, params){
        return "<button class='btn primary' style='font-size:20pt' hx-trigger='click, keyup[altKey&&shiftKey&&code==\"KeyD\"] from:body'" +
                      " hx-post='/doit'>Do It! (alt-shift-D) </button>";
    });
