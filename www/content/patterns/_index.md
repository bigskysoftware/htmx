...
<div class="os9-list-view space-y-8 mt-8">

#### Loading

<div class="not-prose">
<a href="/patterns/click-to-load">
    <iconify-icon icon="mdi:cursor-pointer"></iconify-icon>
    <strong>Load on Click</strong> Load more content when user clicks
</a>

<a href="/patterns/infinite-scroll">
    <iconify-icon icon="mdi:arrow-expand-down"></iconify-icon>
    <strong>Infinite Scroll</strong> Load more content when user scrolls to bottom
</a>

<a href="/patterns/lazy-load">
    <iconify-icon icon="bitcoin-icons:visible-filled"></iconify-icon>
    <strong>Lazy Load</strong> Defer loading content until after page renders
</a>

<a href="/patterns/progress-bar">
    <iconify-icon icon="vaadin:progressbar"></iconify-icon>
    <strong>Progress Bar</strong> Show progress for long-running operations
</a>
</div>
...
<div class="not-prose">
<a href="/patterns/inline-validation">
    <iconify-icon icon="mdi:check-circle-outline"></iconify-icon>
    <strong>Inline Validate</strong> Validate field as user types
</a>

<a href="/patterns/active-search">
    <iconify-icon icon="mdi:magnify"></iconify-icon>
    <strong>Active Search</strong> Search & filter content as user types
</a>

<a href="/patterns/value-select">
    <iconify-icon icon="mdi:form-dropdown"></iconify-icon>
    <strong>Dependent Inputs</strong> Update select options based on another select
</a>

<a href="/patterns/file-upload">
    <iconify-icon icon="mdi:upload"></iconify-icon>
    <strong>File Upload</strong> Upload files and preserve inputs after errors
</a>

<a href="/patterns/click-to-edit">
    <iconify-icon icon="mdi:pencil"></iconify-icon>
    <strong>Inline Edit</strong> Edit a record in place, without a page refresh
</a>

<a href="/patterns/delete-row">
    <iconify-icon icon="mdi:trash-can"></iconify-icon>
    <strong>Inline Delete</strong> Remove a row from the table with animation
</a>

<a href="/patterns/bulk-update">
    <iconify-icon icon="mdi:checkbox-multiple-marked"></iconify-icon>
    <strong>Bulk Actions</strong> Select & update multiple rows at once
</a>

<a href="/patterns/sortable">
    <iconify-icon icon="tabler:drag-drop-2"></iconify-icon>
    <strong>Drag to Reorder</strong> Reorder items by dragging them to new positions
</a>

<a href="/patterns/reset-user-input">
    <iconify-icon icon="mdi:eraser"></iconify-icon>
    <strong>Reset on Submit</strong> Clear form inputs after user submission
</a>
</div>
...
<div class="not-prose">
<a href="/patterns/dialogs">
    <iconify-icon icon="mdi:window-maximize"></iconify-icon>
    <strong>Modal Dialog</strong> Display content in overlay dialogs
</a>

<a href="/patterns/confirm">
    <iconify-icon icon="mdi:alert-circle-outline"></iconify-icon>
    <strong>Confirm Dialog</strong> Ask user to confirm before taking action
</a>

<a href="/patterns/tabs-hateoas">
    <iconify-icon icon="mdi:tab"></iconify-icon>
    <strong>Tabs</strong> Switch between content panels using tabs
</a>

<a href="/patterns/animations">
    <iconify-icon icon="mdi:animation"></iconify-icon>
    <strong>View Transitions</strong> Add smooth animations when content changes
</a>
</div>
...
<div class="not-prose">
<a href="/patterns/update-other-content">
    <iconify-icon icon="mdi:sync"></iconify-icon>
    <strong>Multiple Swaps</strong> Update multiple page elements from one request
</a>

<a href="/patterns/keyboard-shortcuts">
    <iconify-icon icon="mdi:keyboard"></iconify-icon>
    <strong>Keyboard Shortcuts</strong> Bind keyboard shortcuts to interactive elements
</a>

<a href="/patterns/async-auth">
    <iconify-icon icon="mdi:lock"></iconify-icon>
    <strong>Async Authentication</strong> Refresh authentication tokens before requests
</a>

<a href="/patterns/web-components">
    <iconify-icon icon="mdi:puzzle"></iconify-icon>
    <strong>Web Components</strong> Use htmx with web components and shadow DOM
</a>

<a href="/patterns/move-before">
    <iconify-icon icon="mdi:flask-outline"></iconify-icon>
    <strong>DOM Preservation</strong> Preserve elements using new DOM moveBefore API
</a>
</div>

</div>

<div class="os9-info-box not-prose hotwire-migration">
...
<p>See the <a href="/migration-guide-hotwire-turbo">migration guide</a> for common patterns.</p>
</div>
</div>

<div class="os9-info-box not-prose">
<iconify-icon icon="mdi:github" class="box-icon size-8" height="none"></iconify-icon>
<div>
<h2>Server-side Integration Examples</h2>
<p>See the <a href="/server-examples">server examples</a> for htmx integration with various languages.</p>
</div>
</div>
