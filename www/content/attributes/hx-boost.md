...
swap will be used. The url will be pushed and a history entry will be created, as with a normal form
submission. (You can set [hx-push-url](@/attributes/hx-push-url.md) to `false` to prevent this.)
