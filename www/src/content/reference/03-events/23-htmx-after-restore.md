...
The `htmx:after:restore` event fires after elements marked with [`hx-preserve`](/reference/attributes/hx-preserve) have been moved back into their original positions.
