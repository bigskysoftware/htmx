---
title: "hx-delete"
description: "Issues `DELETE` request to specified URL"
---
...
* You can control the data submitted with the request in various ways, documented
  here: [Parameters](/docs#input-values)
* To remove the element following a successful `DELETE`, return a `200` status code with an empty body; if the server
  responds with a `204`, no swap takes place, documented here: [Requests & Responses](/docs#issuing-requests--handling-responses)
