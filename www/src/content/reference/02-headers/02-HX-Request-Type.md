...
Used when the [target](/docs#targeting-elements) is the document body, or when selecting elements from the response (with [`hx-select`](/reference/attributes/hx-select)).
