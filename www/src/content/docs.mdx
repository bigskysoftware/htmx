...
<Code lang="html" code={`<script src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5" integrity="${integrity.min}" crossorigin="anonymous"></script>`} theme="css-variables" transformers={[codeBlockTransformer]} />

#### Unminified

<Code lang="html" code={`<script src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.js" integrity="${integrity.full}" crossorigin="anonymous"></script>`} theme="css-variables" transformers={[codeBlockTransformer]} />

#### ES Module

<Code lang="html" code={`<script type="module" src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.esm.min.js" integrity="${integrity.esmMin}" crossorigin="anonymous"></script>`} theme="css-variables" transformers={[codeBlockTransformer]} />

#### ES Module (unminified)

<Code lang="html" code={`<script type="module" src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.esm.js" integrity="${integrity.esm}" crossorigin="anonymous"></script>`} theme="css-variables" transformers={[codeBlockTransformer]} />

### Download

Instead of using a CDN, consider [self-hosting in production](https://blog.wesleyac.com/posts/why-not-javascript-cdn).

1. Download <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.min.js">htmx.min.js</a>
...
Download: <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.js">htmx.js</a> (unminified)

Download: <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.esm.min.js">htmx.esm.min.js</a> (ES module)

Download: <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta5/dist/htmx.esm.js">htmx.esm.js</a> (ES module, unminified)

### npm

```sh
npm install htmx.org@4.0.0-beta5
```
