...
> programmer to understand that source by looking at only a small portion of
> it." -- [Richard Gabriel](https://www.dreamsongs.com/Files/PatternsOfSoftware.pdf)
...
The LoB principle is a simple prescriptive formulation of the quoted statement
from [Richard Gabriel](https://www.dreamsongs.com).
...
* [DRY - Don't Repeat Yourself](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself)
  ...
  DRY",
  i.e. Don't Repeat Yourself. Like other software design principles this, on its own, is a good thing. htmx, for
  example,
  allows you to place many attributes on parent elements in a DOM and avoid repeating these attributes on children. This
  is a
...
* [SoC - Separation Of Concerns](https://en.wikipedia.org/wiki/Separation_of_concerns)
  ...
  its own and
  in isolation this may, indeed, be a good thing. Inlining
  styles [has become more prevalent lately](https://tailwindcss.com/),
