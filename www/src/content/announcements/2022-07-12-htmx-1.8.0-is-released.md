...
description: "Release announcement, 2022-07-12."
created: 2022-07-12
authors: ["htmx"]
---
...
* The [`hx-replace-url`](/reference/attributes/hx-replace-url) attribute was introduced, allowing you to replace
...
* The new [`hx-select-oob`](/reference/attributes/hx-select-oob) attribute selects one or more elements from a server response to swap in via an out of band swap
* The new [`hx-replace-url`](/reference/attributes/hx-replace-url) attribute can be used to replace the current URL in the location
