...
description: "Release announcement, 2021-05-25."
created: 2021-05-25
authors: ["htmx"]
---
...
* Added the `queue` option to the [hx-trigger](/reference/attributes/hx-trigger) attribute, allowing you to specify how events
...
* The `htmx.config.useTemplateFragments` option was added, allowing you to use HTML template tags for parsing content
  ...
  IE11 compatible.
* Introduced a new synthetic event, [intersect](/docs#special-events) that allows you to trigger when an item is scrolled into view
