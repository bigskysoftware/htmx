...
description: "Release announcement, 2021-11-22."
created: 2021-11-22
authors: ["htmx"]
---
...
* Fixed the `from:` option in [`hx-trigger`](/reference/attributes/hx-trigger) to support `closest <CSS selector>` 
...
* Process all [`hx-ext`](/reference/attributes/hx-ext) attributes, even if no other htmx attribute is on the element
