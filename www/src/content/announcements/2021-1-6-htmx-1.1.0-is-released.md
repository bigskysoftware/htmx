...
description: "Release announcement, 2021-01-06."
created: 2021-01-06
authors: ["htmx"]
---
...
There are also new examples, including [keyboard shortcuts](/patterns/keyboard-shortcuts) and
[drag and drop list reordering with Sortable.js](/patterns/sortable).
...
* Support for the [`htmx.ajax()`](/reference/methods/htmx-ajax) javascript function, to issue an htmx-style ajax 
...
* Added the [`hx-preserve`](/reference/attributes/hx-preserve) attribute, which allows 
...
* Now support the `from:` clause on [`hx-trigger`](/reference/attributes/hx-trigger) to
...
* Added `closest` syntax support for the [`hx-indicator`](/reference/attributes/hx-indicator) attribute
