...
description: "Release announcement, 2022-02-22."
created: 2022-02-22
authors: ["htmx"]
---
...
* The new [`hx-sync`](/reference/attributes/hx-sync) attribute allows you to synchronize multiple element requests on a single
...
* You can now mask out [attribute inheritance](/docs#inheritance) via the [`hx-disinherit`](/reference/attributes/hx-disinherit) attribute.
...
* The `this` symbol now resolves properly for the [`hx-include`](/reference/attributes/hx-include) and [`hx-indicator`](/reference/attributes/hx-indicator)
  attributes
* When an object is included via the [`hx-vals`](/reference/attributes/hx-vals) attribute, it will be converted to JSON (rather 
