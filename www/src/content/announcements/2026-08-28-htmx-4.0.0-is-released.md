...
![htmx 4 rally car](/img/htmx-4-quattro.png)
...
remain `latest` and the 4.0 line will remain `next` until TODO. The website, however, will reference 4.0.
...
Woudln't be an htmx update without upgrade music:
