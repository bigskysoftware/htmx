...
[//]: # (		        class="px-4 py-2 border-b-2 border-transparent aria-selected:border-blue-600 aria-selected:text-blue-600 dark:aria-selected:border-blue-600 dark:aria-selected:text-blue-600 hover:text-blue-600 dark:hover:text-blue-600 select-none">)
...
[//]: # (	const tabClasses = "px-4 py-2 border-b-2 border-transparent aria-selected:border-blue-600 aria-selected:text-blue-600 dark:aria-selected:border-blue-600 dark:aria-selected:text-blue-600 hover:text-blue-600 dark:hover:text-blue-600 select-none";)
