...
Many interesting animations can be created by using the [`class-tools`](https://github.com/bigskysoftware/htmx-extensions/blob/main/src/class-tools/README) extension.
...
via the `transition` option of the [`hx-swap`](/reference/attributes/hx-swap) attribute.
