...
const PAGE_SIZE = 3;
const fade = "starting:opacity-0 starting:translate-y-1 transition duration-300 ease-out";
...
const btn = "w-full flex items-center justify-center gap-2.5 py-2 text-[0.8125rem] font-medium text-neutral-500 dark:text-neutral-400 bg-transparent rounded-md cursor-pointer transition hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:text-neutral-700 dark:hover:text-neutral-200 active:scale-[0.98]";
