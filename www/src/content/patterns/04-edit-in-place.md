...
function viewHTML() {
    return `
<div id="user-view" class="p-5 border border-neutral-200 dark:border-neutral-800 rounded-lg w-full max-w-sm" hx-target:inherited="this" hx-swap:inherited="outerHTML">
    <div class="mb-3">
    ...
    <button class="px-3.5 py-1.5 text-sm font-medium rounded-md cursor-pointer border border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300 interact:bg-neutral-50 dark:interact:bg-neutral-850 active:scale-[0.98] transition" hx-get="/users/1/edit">Edit</button>
</div>`;
}
...
<form id="user-view" class="p-5 border border-neutral-200 dark:border-neutral-800 rounded-lg w-full max-w-sm" hx-put="/users/1" hx-target:inherited="this" hx-swap:inherited="outerHTML">
    <div class="mb-3">
...
<div id="demo-content" class="not-prose demo-container flex justify-center min-h-[292px]"></div>
