...
import serviceWorkerChart from '../../assets/img/you-cant/service-worker-chart.png';
import workboxCfg from '../../assets/img/you-cant/workbox-cfg.png';
import serviceWorker from '../../assets/img/you-cant/service-worker.png';
import speculationRules from '../../assets/img/you-cant/speculation-rules.png';
import workboxOfflineCfg from '../../assets/img/you-cant/workbox-offline-cfg.png';
import crossDocTransitionsCss from '../../assets/img/you-cant/cross-doc-transitions-css.png';
...
<Image src={serviceWorkerChart} alt="Service worker chart"/>
...
3. **Configure Asset Handling**: In the generated `workbox-config.js` file, define how different assets should be
   ...
   <Image src={workboxCfg} alt="Workbox configuration example" />
...
<Image src={serviceWorker} alt="Registered service worker in Chrome browser console" />

Image showing the registered service worker from the Chrome browser console.

### [

`Speculation Rules API`](https://developer.mozilla.org/en-US/docs/Web/API/Speculation_Rules_API): Prerender pages for
...
<Image src={speculationRules} alt="Speculation rules configuration example" />
...
<Image src={workboxOfflineCfg} alt="Workbox offline configuration" />
...
<Image src={crossDocTransitionsCss} alt="Cross-document transitions CSS example" />
...
## Final Myth: Without a

*“Proper”* frontend framework, your Client-side Javascript will
be [Spaghetti and Unmaintainable](https://www.reddit.com/r/webdev/comments/bkk0gl/avoiding_the_vanillajs_spaghetticode/).
