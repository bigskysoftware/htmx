...
import whatIf from '../../assets/img/what-if.png';
...
* A simpler front end allows you to save your [complexity budget](/essays/complexity-budget) for the back end
  functionality
...
Of course, none of the constraints are inherent in the concept of a hypertext, and the goal of [htmx](/)
...
<Image src={whatIf} alt="What if meme" />
