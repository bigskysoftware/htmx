...
That said, [infinite scroll](/patterns/infinite-scroll) can be achieved quite easily using htmx, in a
...
That being said, htmx supports using [standard CSS transitions](/patterns/animations) to make animations possible.
...
htmx offers multiple ways to [update content beyond the target element](/patterns/update-other-content), all of them
...
It turns out, however, that those usability issues often *can* [be addressed](/patterns/_index) using The Hypermedia
Approach:
