...
Use any [extended selector](/docs/core-concepts/extended-selectors) to target elements:
...
See the full [extended selectors](/docs/core-concepts/extended-selectors) guide.
